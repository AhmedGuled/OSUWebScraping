...
file_path = './directories/NESA_directory.csv'
...
for index, row in professors_data.iterrows():
    ...
    url = f"https://nesa.osu.edu/people/{lastname}.{dot_num}"
...
output_file = "./TechDirectories/Tech_Interested_Professors_nesa.csv"
