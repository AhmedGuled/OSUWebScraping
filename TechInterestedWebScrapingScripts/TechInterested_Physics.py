...
file_path = './directories/Physics_directory.csv'
...
for index, row in professors_data.iterrows():
    ...
    url = f"https://physics.osu.edu/people/{lastname}.{dot_num}"
...
output_file = "./TechDirectories/Tech_Interested_Professors_physics.csv"
