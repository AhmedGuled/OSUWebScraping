...
file_path = './directories/Microbiology_directory.csv'
...
for index, row in professors_data.iterrows():
    ...
    url = f"https://microbiology.osu.edu/people/{lastname}.{dot_num}"
...
output_file = "./TechDirectories/Tech_Interested_Professors_microbiology.csv"
