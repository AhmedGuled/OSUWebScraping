...
file_path = './directories/Sociology_directory.csv'
...
for index, row in professors_data.iterrows():
    ...
    url = f"https://sociology.osu.edu/people/{lastname}.{dot_num}"
...
output_file = "./TechDirectories/Tech_Interested_Professors_sociology.csv"
