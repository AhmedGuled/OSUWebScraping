...
for index, row in professors_data.iterrows():
    name = row['Name']
    email = row['Email']  # Handle dotnum if email is N/A
...
output_df.to_csv("./TechDirectories/Tech_Interested_Professors_communications.csv", index=False, mode='w')

print("Script complete. Results written to Tech_Interested_Professors_communications.csv.")
