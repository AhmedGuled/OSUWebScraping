...
file_path = './directories/Music_directory.csv'
...
for index, row in professors_data.iterrows():
    ...
    url = f"https://music.osu.edu/people/{lastname}.{dot_num}"
...
output_file = "./TechDirectories/Tech_Interested_Professors_music.csv"
