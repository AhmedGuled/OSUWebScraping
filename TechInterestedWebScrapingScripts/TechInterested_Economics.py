...
for index, row in professors_data.iterrows():
    ...
    url = f"https://economics.osu.edu{lastname}.{dot_num}"
...
file_exists = os.path.isfile("./TechDirectories/Tech_Interested_Professors_economics.csv")

# Append results to the CSV file
if file_exists:
    # If the file exists, append without writing the header
    output_df.to_csv("./TechDirectories/Tech_Interested_Professors_economics.csv", mode='a', header=False, index=False)
else:
    # If the file doesn't exist, create it with headers
    output_df.to_csv("./TechDirectories/Tech_Interested_Professors_economics.csv", index=False)

print("Script complete. Results appended to Tech_Interested_Professors_economics.csv.")
