...
for index, row in professors_data.iterrows():
    ...
    url = f"https://frit.osu.edu/people/{lastname}.{dot_num}"
...
output_df.to_csv("./TechDirectories/Tech_Interested_Professors_frit.csv", index=False, mode='w')

print("Script complete. Results written to Tech_Interested_Professors_frit.csv.")
