...
# Input file path
file_path = './directories/SPHS_directory.csv'

# Ensure input directory file exists
...
for index, row in professors_data.iterrows():
    ...
    url = f"https://sphs.osu.edu/people/{lastname}.{dot_num}"
...
# Output file path
output_file = "./TechDirectories/Tech_Interested_Professors_sphs.csv"
