...
output_df.to_csv("./TechDirectories/Tech_Interested_Professors_astronomy.csv", mode='w', index=False)

print("Script complete. Results saved to Tech_Interested_Professors_astronomy.csv.")
