...
file_path = './directories/Slavic_directory.csv'
...
for index, row in professors_data.iterrows():
    ...
    url = f"https://slavic.osu.edu/people/{lastname}.{dot_num}"
...
output_file = "./TechDirectories/Tech_Interested_Professors_slavic.csv"
