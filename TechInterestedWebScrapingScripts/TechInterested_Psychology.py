...
file_path = './directories/Psychology_directory.csv'
...
for index, row in professors_data.iterrows():
    ...
    url = f"https://psychology.osu.edu/people/{lastname}.{dot_num}"
...
output_file = "./TechDirectories/Tech_Interested_Professors_psychology.csv"
