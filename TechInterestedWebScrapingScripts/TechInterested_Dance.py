...
results = []
base_url = "https://dance.osu.edu"

# Iterate through each professor entry
for index, row in professors_data.iterrows():
    name = row['Name']
    relative_url = row['Email']  # This column actually contains the relative profile URL
...
# Save results to CSV
output_file_path = "./TechDirectories/Tech_Interested_Professors_dance.csv"
