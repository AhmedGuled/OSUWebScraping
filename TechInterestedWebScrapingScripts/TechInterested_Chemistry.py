...
output_df.to_csv("./TechDirectories/Tech_Interested_Professors_chemistry.csv", index=False, mode='w')

print("Script complete. Results written to Tech_Interested_Professors_chemistry.csv.")
