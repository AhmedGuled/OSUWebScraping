...
for index, row in professors_data.iterrows():
    ...
    url = f"https://history.osu.edu/people/{lastname}.{dot_num}"
...
output_df.to_csv("./TechDirectories/Tech_Interested_Professors_history.csv", mode='w', header=True, index=False)

print("Script complete. Results written to Tech_Interested_Professors_history.csv.")
