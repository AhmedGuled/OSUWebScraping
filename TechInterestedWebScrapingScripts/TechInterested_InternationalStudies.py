...
file_path = './directories/InternationalStudies_directory.csv'
...
for index, row in professors_data.iterrows():
    ...
    url = f"https://internationalstudies.osu.edu/people/{lastname}.{dot_num}"  # Fixed URL construction
...
file_exists = os.path.isfile("./TechDirectories/Tech_Interested_Professors_internationalstudies.csv")

# Append results to the CSV file
if file_exists:
    # If the file exists, append without writing the header
    output_df.to_csv("./TechDirectories/Tech_Interested_Professors_internationalstudies.csv", mode='a', header=False, index=False)
else:
    # If the file doesn't exist, create it with headers
    output_df.to_csv("./TechDirectories/Tech_Interested_Professors_internationalstudies.csv", index=False)

print("Script complete. Results appended to Tech_Interested_Professors_internationalstudies.csv.")
