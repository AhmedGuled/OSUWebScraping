...
# Set the URL and CSV filename
url = "https://linguistics.osu.edu/people"
csv_filename = "Linguistics_directory.csv"
...
with open(csv_filename, mode='w', newline='') as file:
    ...
    for person in people_rows:
        # Extract the title and filter for 'lecturer' or 'professor'
